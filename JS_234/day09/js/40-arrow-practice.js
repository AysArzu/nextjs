/* Ürün fiyatı, kdv oranı ve indirim oranı parametre olarak alıp 
son fiyatı hesaplayan fonksiyonu arrow function ile yazınız. 
...
let calculate = (price, tax, discount) => {
  ...
  let total = price - totalDiscount + totalTax;
